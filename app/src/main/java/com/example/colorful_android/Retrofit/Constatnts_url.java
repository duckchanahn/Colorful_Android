...
//    public static final String BASE_URL = "http://localhost:7777/";
    ...
    public static final String BASE_URL_MYDEVICE_DH = "http://172.30.104.131:7777/";
    public static final String BASE_URL_MYDEVICE = "http://172.30.1.23:7777/";
    ...
    public static final String SIGNIN_URL = "customer/signin/";
    ...
    // 여행지
    public static final String TOURSPOT = "tourspot/detail";
    ...
    public static final String PALETTE = "tourspot/palette/detail";
    ...
    public static final String PALETTE_LIST = "tourspot/palette/list";
