...
class AddListAdapter(val context: Context, val AddTourList: ArrayList<TourInfoAdd>) : BaseAdapter() {
    override fun getCount(): Int {
        return AddTourList.size
    }

    override fun getItem(position: Int): Any {
        return AddTourList[position]
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val view : View = LayoutInflater.from(context).inflate(R.layout.tour_add_card_view, null)
