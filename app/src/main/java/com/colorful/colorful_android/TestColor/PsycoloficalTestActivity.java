...
import com.colorful.colorful_android.DTO.PsycologicaltestAnswerDTO;
import com.colorful.colorful_android.DTO.PsycologicaltestQuestionDTO;
...
//                Log.e("excute", "connector : " + connector.size());
    ...
    private void excute_UpdateResult(PsycoloficalTestActivity psycoloficalTestActivity, String result) {
        Call<Integer> call_a = MyRetrofit.getApiService().updatePsycologicalResult(Customer.getInstance().getCustomerId(), result);
